<template>
  <div class="main-content">
    <template v-if="showFlag">
      <div class="search-box-card">
        ...
        <el-row class="btn-group">
          ...
          <el-button type="success" icon="el-icon-plus" @click="addOrUpdateHandler()" size="medium">新增信息</el-button>
      ...
      <div class="table-box-card">
        <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandler" style="width: 100%;">
          ...
          <el-table-column prop="haicheriqi" header-align="center" align="center" label="还车日期" width="100"></el-table-column>
          ...
          <el-table-column prop="guanlixingming" header-align="center" align="center" label="经办人"></el-table-column>
          ...
          <el-table-column header-align="center" align="center" width="200" label="操作" fixed="right">
            <template slot-scope="scope">
              <el-button v-if="isAuth('haichexinxi','审核') && scope.row.sfsh=='待审核'" type="warning" size="mini" @click="shDialog(scope.row)">审核</el-button>
              <el-button v-if="isAuth('haichexinxi','查看')" type="text" icon="el-icon-view" size="small" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
              <el-button v-if="isAuth('haichexinxi','修改')" type="text" icon="el-icon-edit" size="small" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
              <el-button v-if="isAuth('haichexinxi','删除')" type="text" icon="el-icon-delete" class="text-danger" size="small" @click="deleteHandler(scope.row.id)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
    ...
    <el-dialog title="审核" :visible.sync="sfshVisiable" width="40%" center>
